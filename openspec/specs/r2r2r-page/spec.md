# r2r2r-page Specification

## Purpose

Defines the Rim-to-Rim-to-Rim Grand Canyon training plan page at `/r2r2r`. The page is a content-heavy editorial document with its own warm cream theme, sticky in-page navigation, phase-tab schedule, expandable week cards, and scroll-tracked active nav highlighting.
