...
const PHASES = [
  {
    ...
    weeks: [1, 2, 3, 4],
    color: "#3d8b8a",
    desc: "Aerobic base, vert consistency, movement patterns",
  },
  {
    name: "Build",
    weeks: [5, 6, 7, 8],
    color: "#c47d2e",
    desc: "Max strength, hill sprints w/ poles, vert progression",
  },
  {
    name: "Specific",
    weeks: [9, 10, 11, 12],
    color: "#8b5fbf",
    desc: "Muscular endurance carries, steady climbs, peak vert",
  },
];
...
const PLAN = [
  {
    ...
    hours: 6,
    vert: "5,500",
    note: "Establish AeT with drift test on a sustained 2,000 ft climb. All uphill work conversational.",
    days: [
      { day: "Mon", type: "strength", time: 35, desc: "General Strength A — see program" },
      {
        ...
        time: 60,
        vert: 1500,
        desc: "Mountain run/hike Z2. Use poles on steep sections. Nose-breathing pace.",
      },
      {
        day: "Wed",
        type: "easy_strides",
        time: 35,
        desc: "Flat/rolling easy run Z2 + 5×20s strides. Leg speed maintenance.",
      },
      { day: "Thu", type: "strength", time: 35, desc: "General Strength B" },
      {
        ...
        time: 50,
        vert: 1000,
        desc: "Pole striding on moderate-to-steep grade (15–25%). Z2. Push through poles, exaggerated stride.",
      },
      {
        day: "Sat",
        type: "long_vert",
        time: 120,
        vert: 3000,
        desc: "Long mountain day Z1–2. Stride the ups, run flats/downs. 3,000 ft vert target.",
      },
  ...
  },
  {
    ...
    hours: 6.5,
    vert: "6,000",
    note: "Add bounding drills. Build vert gradually. Focus on uphill economy.",
    days: [
      { day: "Mon", type: "strength", time: 35, desc: "General Strength A" },
      {
        ...
        time: 65,
        vert: 1600,
        desc: "Mountain run/hike Z2. Seek sustained climbs >1,000 ft. Poles on steeps.",
      },
      ...
      { day: "Thu", type: "strength", time: 35, desc: "General Strength B" },
      {
        ...
        time: 55,
        vert: 1100,
        desc: "Pole striding Z2 + 4×30s bounding drills on steep hill. Full walk-down recovery.",
      },
      {
        day: "Sat",
        type: "long_vert",
        time: 130,
        vert: 3300,
        desc: "Long mountain day Z1–2. Practice pacing by HR on the big climb.",
      },
      { day: "Sun", type: "rest", desc: "Full rest." },
    ],
  },
  {
    ...
    hours: 7,
    vert: "6,800",
    note: "Peak Foundation vert. Push long day. Monitor HR drift on sustained climb.",
    days: [
      { day: "Mon", type: "strength", time: 35, desc: "General Strength A — progress loads" },
      {
        ...
        time: 65,
        vert: 1700,
        desc: "Mountain run/hike Z2. Include a 2,000 ft climb if possible.",
      },
      ...
      { day: "Thu", type: "strength", time: 35, desc: "General Strength B" },
      {
        ...
        time: 55,
        vert: 1100,
        desc: "Pole striding Z2 + 5×30s bounding drills. Explosive push through poles.",
      },
      {
        day: "Sat",
        type: "long_vert",
        time: 140,
        vert: 3800,
        desc: "Big mountain day Z1–2. Note vert rate at same HR as week 1. Fuel every 45 min.",
      },
  ...
  },
  {
    ...
    hours: 4.5,
    vert: "3,500",
    note: "⟳ DELOAD. Reduce volume ~40%. AeT drift test on a 2,000 ft climb. 1 strength session.",
    days: [
      ...
      { day: "Thu", type: "rest", desc: "Full rest." },
      {
        ...
        time: 60,
        vert: 1500,
        desc: "AeT drift test: sustained Z2 climb. Compare 1st/2nd half avg HR.",
      },
      {
        day: "Sat",
        type: "long_vert",
        time: 70,
        vert: 1500,
        desc: "Moderate mountain outing Z1–2. Enjoy feeling fresh.",
      },
      { day: "Sun", type: "rest", desc: "Full rest." },
    ],
  },
  {
    ...
    hours: 7,
    vert: "7,000",
    note: "Transition to heavy compound lifts. Hill sprints with poles. Resume vert build.",
    days: [
      ...
      { day: "Tue", type: "uphill_easy", time: 65, vert: 1700, desc: "Mountain run/hike Z2 with poles." },
      {
        ...
        vert: 500,
        desc:
          "Warmup 15 min → 6×10s max hill sprints w/ poles on very steep grade (>20%). Full walk-down recovery. Then 4×30s bounds.",
      },
      ...
      { day: "Fri", type: "pole_stride", time: 55, vert: 1100, desc: "Pole striding Z2. Sustained rhythm on grade." },
      {
        ...
        time: 140,
        vert: 3700,
        desc: "Long mountain day Z1–2. Stride ups, run flats/downs.",
      },
      { day: "Sun", type: "rest", desc: "Full rest." },
    ],
  },
  {
    ...
    hours: 7.5,
    vert: "7,800",
    note: "Extend hill sprints. Push heavier in the gym. Big vert on Saturday.",
    days: [
      { day: "Mon", type: "strength", time: 40, desc: "Max Strength A" },
      {
        ...
        time: 70,
        vert: 1800,
        desc: "Mountain run/hike Z2. Varied terrain — steep trail, ridgeline, off-trail.",
      },
      {
        day: "Wed",
        type: "hill_sprint",
        time: 55,
        vert: 600,
        desc: "Warmup → 8×10s max hill sprints w/ poles + 5×30s bounds. Full recovery between all efforts.",
      },
      { day: "Thu", type: "strength", time: 40, desc: "Max Strength B" },
      { day: "Fri", type: "easy", time: 35, desc: "Easy flat run Z2. Let legs recover for big Saturday." },
      {
        ...
        time: 150,
        vert: 4200,
        desc: "Big mountain day Z1–2. Target a 4,000+ ft route. Poles for all major climbs.",
      },
  ...
  },
  {
    ...
    hours: 8,
    vert: "8,500",
    note: "Peak Build week. Heaviest strength loads. Biggest vert before deload.",
    days: [
      { day: "Mon", type: "strength", time: 40, desc: "Max Strength A — aim for peak loads this phase" },
      {
        ...
        time: 70,
        vert: 2000,
        desc: "Mountain run/hike Z2. Include a sustained 2,000 ft climb.",
      },
      {
        day: "Wed",
        type: "hill_sprint",
        time: 55,
        vert: 600,
        desc: "Warmup → 8×10s hill sprints + 6×30s bounds w/ poles. Full recovery.",
      },
      { day: "Thu", type: "strength", time: 40, desc: "Max Strength B" },
      { day: "Fri", type: "pole_stride", time: 55, vert: 1200, desc: "Pole striding on steep terrain Z2." },
      {
        ...
        time: 160,
        vert: 4700,
        desc: "Biggest mountain day yet. Z1–2. Link multiple climbs. Fuel well. Practice race-day pacing.",
      },
      { day: "Sun", type: "rest", desc: "Full rest." },
    ],
  },
  {
    ...
    hours: 4.5,
    vert: "3,800",
    note: "⟳ DELOAD. Recover. AeT test on sustained climb. Compare to week 4. 1 strength session.",
    days: [
      ...
      { day: "Thu", type: "rest", desc: "Full rest." },
      {
        ...
        time: 60,
        vert: 1500,
        desc: "AeT drift test on 2,000 ft climb. Compare to week 4.",
      },
  ...
  },
  {
    ...
    hours: 7.5,
    vert: "8,500",
    note: "Sport-specific phase. Introduce ME weighted carries. Maintain gym strength (1×/wk).",
    days: [
      {
        day: "Mon",
        type: "strength",
        time: 40,
        desc: "Maintenance Strength — fewer sets at Build loads (see Specific)",
      },
      { day: "Tue", type: "uphill_easy", time: 65, vert: 1700, desc: "Mountain run/hike Z2 with poles." },
      {
        day: "Wed",
        ...
        vert: 1800,
        desc:
          "Weighted uphill carry: 5–10% BW in pack (water jugs). Steep grade (>20%). Z3 legs, Z2 lungs. Dump water at top, easy descent. 40–50 min climbing.",
      },
      ...
      { day: "Fri", type: "pole_stride", time: 55, vert: 1200, desc: "Pole striding Z2 + 6×30s bounding drills." },
      {
        ...
        time: 140,
        vert: 4000,
        desc: "Long mountain day Z1–2. Include pole striding on all major climbs.",
      },
  ...
  },
  {
    ...
    hours: 8,
    vert: "9,500",
    note: "Progress ME carry weight. Add steady climb efforts. Approaching peak vert.",
    days: [
      { day: "Mon", type: "strength", time: 40, desc: "Maintenance Strength" },
      {
        ...
        vert: 2000,
        desc:
          "15 min warmup → 30 min steady climb Z3 (no weight, steep sustained grade, poles optional) → 15 min cooldown.",
      },
      { day: "Wed", type: "easy", time: 35, desc: "Easy flat recovery Z2." },
      {
        ...
        time: 75,
        vert: 2000,
        desc: "Weighted carry: 10% BW. Steep grade. Z3 legs, Z2 lungs. 45–55 min climbing. Water jugs — dump at top.",
      },
      { day: "Fri", type: "easy_short", time: 25, desc: "Recovery jog Z1." },
      {
        ...
        time: 160,
        vert: 4500,
        desc: "Big mountain day Z1–2. Start with a 20 min high Z2/low Z3 push on the first major climb, then settle.",
      },
  ...
  },
  {
    ...
    hours: 8,
    vert: "10,500",
    note: "Peak week. Highest vert + heaviest ME carry of the plan. The summit.",
    days: [
      { day: "Mon", type: "strength", time: 40, desc: "Maintenance Strength" },
      {
        day: "Tue",
        ...
        time: 75,
        vert: 2200,
        desc: "15 min warmup → 35 min steady climb Z3 → 15 min cooldown. Poles.",
      },
      { day: "Wed", type: "easy", time: 35, desc: "Easy flat run Z2." },
      {
        ...
        time: 80,
        vert: 2300,
        desc: "Weighted carry: 10–15% BW. Steep grade. 50–60 min of climbing. Leg burn is the limiter, not breathing.",
      },
      { day: "Fri", type: "easy_short", time: 25, desc: "Recovery Z1." },
      {
        ...
        time: 170,
        vert: 5000,
        desc: "Biggest mountain day. Z1–2. 5,000 ft vert. Link climbs. Fuel and pace like race simulation.",
      },
  ...
  },
  {
    ...
    hours: 5,
    vert: "4,500",
    note: "⟳ FINAL DELOAD. AeT test. Compare vert rate and HR to week 1. Ready for snow.",
    days: [
      ...
      { day: "Thu", type: "rest", desc: "Full rest." },
      {
        ...
        time: 60,
        vert: 1500,
        desc: "AeT drift test on sustained 2,000 ft climb. Compare vert rate at same HR to week 1.",
      },
      {
        day: "Sat",
        type: "long_vert",
        time: 90,
        vert: 2500,
        desc: "Mountain outing Z1–2. Enjoy the base you've built.",
      },
...
const STRENGTH = {
  Foundation: {
    ...
    a: {
      ...
      exercises: [
        {
          name: "Goblet Squat → Front Squat",
          sets: "3×10",
          rest: "60s",
          notes: "Goblet wk1, front squat wk2+. Full depth, controlled.",
        },
        {
          name: "Romanian Deadlift (DB/BB)",
          sets: "3×10",
          rest: "60s",
          notes: "Hinge pattern. Hamstring/glute emphasis.",
        },
        {
          name: "Box Step-Up (bench height)",
          sets: "3×8/side",
          rest: "60s",
          notes: "Drive through front heel. Core uphill exercise.",
        },
        {
          name: "Single-Leg Calf Raise (eccentric)",
          sets: "3×10/side",
          rest: "45s",
          notes: "2-up, 1-down. 3s eccentric. Achilles protection.",
        },
    ...
    b: {
      name: "Session B — Stability + Upper Body",
      exercises: [
        { name: "Single-Leg Glute Bridge", sets: "3×12/side", rest: "45s", notes: "2s squeeze at top. Hip stability." },
        {
          ...
          sets: "2×25s/side",
          rest: "45s",
          notes: "Adductor strength. Progress to full lever.",
        },
      ...
      exercises: [
        {
          ...
          sets: "4×5 @75–85% 1RM",
          rest: "2–3 min",
          notes: "Primary lift. Progress load weekly. Full depth.",
        },
        {
          name: "Romanian Deadlift (BB)",
          sets: "3×6",
          rest: "90s",
          notes: "Heavy. Posterior chain for steep climbing.",
        },
        {
          name: "Weighted Step-Up (high box)",
          sets: "3×6/side",
          rest: "90s",
          notes: "DB or BB. Unilateral power. Mimics skinning stride.",
        },
        { name: "Weighted Calf Raise", sets: "3×8", rest: "60s", notes: "Heavy. Alternate straight/bent knee." },
      ],
    },
    b: {
      name: "Session B — Single-Leg + Upper",
      exercises: [
        {
          name: "Bulgarian Split Squat",
          sets: "3×6/side",
          rest: "90s",
          notes: "DB or BB. Single-leg strength for variable terrain.",
        },
        {
          name: "Single-Leg RDL",
          sets: "3×8/side",
        ...
        },
        {
          ...
          sets: "3×8",
          rest: "60s",
          notes: "Upper back. Pole power and pack carry support.",
        },
        {
          name: "Copenhagen Plank (full lever)",
          sets: "3×25s/side",
          rest: "45s",
          notes: "Adductor durability for lateral ski movements.",
        },
  ...
  Specific: {
    ...
    a: {
      name: "Gym Session — Maintain",
      exercises: [
        {
          name: "Back Squat",
          sets: "3×4 (peak load)",
          rest: "2–3 min",
          notes: "Maintain Build phase loads. Fewer sets to manage total load.",
        },
    ...
    b: {
      name: "Mountain ME (replaces gym session B)",
      exercises: [
        {
          name: "Weighted Uphill Carry",
          sets: "1×/week",
          rest: "—",
          notes:
            "5–15% BW in pack (water jugs). Steep grade >20%. Z3 effort — legs burn, lungs manageable. 40–60 min climbing. Dump water at top. 2–3 easy recovery days after.",
        },
        {
          name: "Bounding w/ Poles",
          sets: "Built into pole stride days",
          rest: "—",
          notes: "6×30s explosive bounds uphill with poles. Full walk-down recovery. High load on ski muscles.",
        },
        {
          name: "Why this shift",
          sets: "—",
          rest: "—",
          notes:
            "Johnston's philosophy: in the Specific phase, sport-specific overload replaces the gym. Weighted carries and bounds are the most direct preparation for skinning — sustained high leg force on steep terrain.",
        },
      ],
    },
  },
...
function getPhaseKey(w) {
  return w <= 4 ? "Foundation" : w <= 8 ? "Build" : "Specific";
}
...
export default function UphillPlan() {
  ...
  const renderEx = (ex, i) => (
    <div
      key={i}
      style={{ display: "flex", gap: "10px", padding: "10px 0", borderBottom: "1px solid rgba(255,255,255,0.04)" }}
    >
      <div
        style={{
  ...
  const renderSess = (s, key) => {
    ...
    return (
      <div key={key} style={{ marginBottom: "12px" }}>
        <button
          onClick={() => setOpenSess(open ? null : key)}
          style={{
            width: "100%",
            padding: "12px 14px",
            background: open ? "rgba(212,120,92,0.08)" : "rgba(255,255,255,0.02)",
            border: `1px solid ${open ? "rgba(212,120,92,0.2)" : "rgba(255,255,255,0.06)"}`,
            borderRadius: "10px",
        ...
        {open && (
          <div
            style={{
              ...
              marginTop: "-1px",
              background: "rgba(212,120,92,0.03)",
              border: "1px solid rgba(212,120,92,0.1)",
              borderTop: "none",
    ...
    >
            ...
            return (
              <div
                ...
                style={{
                  flex: 1,
                  height: `${(v / maxV) * 100}%`,
                  background: sel ? p.color : `${p.color}55`,
                  border: sel ? `2px solid ${p.color}` : "none",
                  position: "relative",
                }}
              >
                {sel && (
      ...
      <div style={{ padding: "8px 24px 12px" }}>
        <div style={{ display: "flex", gap: "6px", flexWrap: "wrap" }}>
          {PLAN.map(w => {
            ...
            const sel = w.week === week;
            const dl = [4, 8, 12].includes(w.week);
            return (
              <button
                key={w.week}
                className="wb"
                ...
                style={{
                  width: "40px",
                  height: "36px",
                  border: sel ? `2px solid ${p.color}` : "1px solid rgba(255,255,255,0.1)",
                  borderRadius: "8px",
      ...
      <div style={{ padding: "0 24px 12px" }}>
        ...
        <div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "12px", color: "#666" }}>
          ...
          <span style={{ margin: "0 8px", color: "#333" }}>|</span>
          Strength:{" "}
          <span style={{ color: "#d4785c", fontWeight: 600 }}>
            {deload ? "1×" : getPhaseKey(week) === "Specific" ? "1× gym + 1× ME" : "2×"}/wk
          </span>
        </div>
      </div>
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  ...
                  >
                    {wt.label}
                    {d.time && (
                      <span style={{ color: "#777", fontWeight: 400, marginLeft: "8px" }}>
                        {d.time} min{d.vert ? ` · ${d.vert.toLocaleString()} ft` : ""}
                      </span>
                    )}
                  </div>
                  <div
      ...
      {tab === "strength" && (
        <div style={{ padding: "16px 24px 20px" }}>
          ...
          >
            <strong>Periodization logic:</strong>{" "}
            General → Max Strength → Maintain + ME mirrors Johnston's 16-week skimo plans. The gym builds raw force that
            ME carries then convert into sport-specific endurance. You can't have high muscular endurance without first
            having strength to draw from.
          </div>
        </div>
      )}
      ...
      {tab === "guide" && (
        <div style={{ padding: "16px 24px 20px" }}>
          ...
          >
            Skimo-Specific Workouts
          </div>
          {[
            {
              title: "Pole Striding",
              desc:
                "Simulate skinning motion uphill with trekking/ski poles. Moderate-to-steep grade (15–25%). Exaggerated stride, push hard through poles. Z2 effort. Johnston recommends ≥30% of off-season training in ski-specific simulation for economy transfer.",
              color: "#c47d2e",
            },
            {
              title: "Bounding w/ Poles",
              desc:
                "Explosive uphill bounds with poles on steep terrain. 30s efforts with full walk-down recovery (2–3 min). High load on ski-specific leg muscles. Borrowed from Nordic ski training. Power, not economy.",
              color: "#e0833a",
            },
            {
              title: "ME Weighted Carry",
              desc:
                "Pack with water jugs (5–15% BW). Steep grade (>20%). Hike up at Z3 effort — legs burn while breathing stays manageable. Dump water at top, easy descent. 40–60 min climbing. 1×/week with 2–3 easy days after. The most sport-specific strength workout for going uphill faster, longer.",
              color: "#8b5fbf",
            },
            {
              title: "Hill Sprints w/ Poles",
              desc:
                "8–10s maximal effort uphill with poles on very steep grade (>20%). Full walk-back recovery. HR won't reflect the effort — go by perceived exertion. Raw uphill power development.",
              color: "#e0833a",
            },
            {
              title: "Steady Climb",
              desc:
                "Sustained Z3 on a long climb (20–35 min). No weight. Poles optional. Builds lactate shuttling and sustained climbing pace. Between easy Z2 vert and the ME carry.",
              color: "#7b5ea7",
            },
            {
              title: "AeT Drift Test (uphill)",
              desc:
                "60 min sustained Z2 on a 2,000+ ft climb. Compare avg HR first 30 min vs second 30 min. <5% drift = strong base. >10% = more Z2 volume needed. Test at weeks 4, 8, 12.",
              color: "#3d8b8a",
            },
          ].map((w, i) => (
            <div
      ...
      >
        ...
        {[
          ...
          {
            n: "06",
            t: "After this block, transition to on-snow. Your aerobic base and ME capacity carry directly to skinning.",
          },
        ].map(p => (
        ...
        <div
          style={{
            marginTop: "20px",
            padding: "12px 14px",
            background: "rgba(61,139,138,0.06)",
        ...
        >
          <strong>Calibrated for you:</strong>{" "}
          Starting at 5,500 ft/wk (your comfortable lower range), peaking at 10,500 ft/wk. Long days hit 3,000–5,000 ft
          single-outing vert. With 2,000+ ft climbs at your doorstep, every key workout — AeT tests, ME carries, pole
          striding — happens on real sustained mountain terrain.
        </div>
      </div>
    </div>
  );
