...
const PHASES = [
  {
    ...
    weeks: [1, 2, 3, 4],
    color: "#4a9e6e",
    desc: "Movement quality, bodyweight strength, easy running",
  },
  {
    name: "Build",
    weeks: [5, 6, 7, 8],
    color: "#c47d2e",
    desc: "Heavy compound lifts, hill sprints, extended long run",
  },
  {
    name: "Consolidation",
    weeks: [9, 10, 11, 12],
    color: "#7b5ea7",
    desc: "Strength + muscular endurance, steady-state, peak volume",
  },
];
...
const PLAN = [
  // WEEK 1
  {
    ...
    phase: "Foundation",
    totalMiles: 20,
    note: "Settle into easy effort. Find your Z2 HR ceiling. Learn strength movement patterns.",
    days: [
      ...
      { day: "Tue", type: "easy", time: 35, miles: 3.5, desc: "Easy Z2. Find a comfortable rhythm." },
      {
        ...
        time: 35,
        miles: 3.5,
        desc: "Easy Z2, then 4×20s strides w/ 90s walk recovery.",
      },
  ...
  // WEEK 2
  {
    ...
    phase: "Foundation",
    totalMiles: 22,
    note: "Small volume bump. Keep all effort easy. Progress strength loads slightly.",
    days: [
  ...
  // WEEK 3
  {
    ...
    phase: "Foundation",
    totalMiles: 24,
    note: "Building consistency. Monitor HR drift on long run.",
    days: [
  ...
  // WEEK 4 - DELOAD
  {
    ...
    phase: "Foundation",
    totalMiles: 16,
    note: "⟳ DELOAD. Reduce running ~35%, reduce strength to 1 session.",
    days: [
  ...
  // WEEK 5
  {
    ...
    phase: "Build",
    totalMiles: 25,
    note: "Transition to heavier loads. Introduce hill sprints. Resume volume progression.",
    days: [
      ...
      { day: "Tue", type: "easy", time: 42, miles: 4.5, desc: "Easy Z2." },
      {
        ...
        time: 40,
        miles: 4,
        desc: "Easy Z2 + 6×10s hill sprints w/ full walk-back recovery.",
      },
  ...
  // WEEK 6
  {
    ...
    phase: "Build",
    totalMiles: 27,
    note: "Extend long run. Progressive overload on strength.",
    days: [
      ...
      { day: "Tue", type: "easy", time: 45, miles: 4.5, desc: "Easy Z2." },
      {
        ...
        time: 42,
        miles: 4,
        desc: "Easy Z2 + 8×10s hill sprints w/ full walk-back recovery.",
      },
      { day: "Thu", type: "strength_b", time: 40, desc: "Strength B" },
  ...
  // WEEK 7
  {
    ...
    phase: "Build",
    totalMiles: 30,
    note: "Peak of Build phase. Long run approaching 90 min.",
    days: [
  ...
  // WEEK 8 - DELOAD
  {
    ...
    phase: "Build",
    totalMiles: 20,
    note: "⟳ DELOAD. Recover and absorb. Run AeT test. 1 strength session only.",
    days: [
  ...
  // WEEK 9
  {
    ...
    phase: "Consolidation",
    totalMiles: 31,
    note: "Introduce steady-state run. Shift strength to muscular endurance emphasis.",
    days: [
      ...
      { day: "Tue", type: "easy", time: 45, miles: 5, desc: "Easy Z2." },
      {
        ...
        time: 50,
        miles: 5.5,
        desc: "15 min easy warmup → 20 min steady state → 15 min easy cooldown.",
      },
      { day: "Thu", type: "strength_b", time: 40, desc: "Strength B" },
  ...
  // WEEK 10
  {
    ...
    phase: "Consolidation",
    totalMiles: 34,
    note: "Extend steady state. Approaching peak volume.",
    days: [
      { day: "Mon", type: "strength_a", time: 40, desc: "Strength A" },
  ...
  // WEEK 11
  {
    ...
    phase: "Consolidation",
    totalMiles: 36,
    note: "Peak week. Highest volume of the plan.",
    days: [
      { day: "Mon", type: "strength_a", time: 40, desc: "Strength A" },
  ...
  // WEEK 12 - DELOAD / TEST
  {
    ...
    phase: "Consolidation",
    totalMiles: 22,
    note: "⟳ FINAL DELOAD. Run AeT test — compare to week 1. 1 strength session.",
    days: [
      ...
      { day: "Thu", type: "rest", desc: "Full rest." },
      {
        ...
        time: 35,
        miles: 3.5,
        desc: "AeT drift test: 60 min Z2, compare 1st & 2nd half avg HR.",
      },
      ...
      exercises: [
        {
          ...
          sets: "3×10",
          rest: "60s",
          notes: "Bodyweight wk1 → add dumbbell wk2+. Full depth, controlled tempo.",
        },
        {
          name: "Romanian Deadlift (DB)",
          sets: "3×10",
          rest: "60s",
          notes: "Light dumbbells. Hinge at hips, slight knee bend. Feel hamstrings stretch.",
        },
        {
          name: "Walking Lunge",
          sets: "2×8/side",
          rest: "60s",
          notes: "Bodyweight. Controlled step, knee tracks over toes.",
        },
        { name: "Single-Leg Glute Bridge", sets: "2×12/side", rest: "45s", notes: "Squeeze glute at top. 2s hold." },
        {
          name: "Calf Raise (2-up, 1-down)",
          sets: "3×10/side",
          rest: "45s",
          notes: "Rise on both feet, lower slowly on one. 3s eccentric.",
        },
        {
          name: "Dead Bug",
          sets: "3×8/side",
          rest: "45s",
          notes: "Keep lower back pressed to floor. Breathe out on extension.",
        },
      ],
    },
    sessionB: {
      ...
      exercises: [
        {
          name: "Step-Up (bench height)",
          sets: "3×8/side",
          rest: "60s",
          notes: "Bodyweight → add dumbbells. Drive through front heel.",
        },
        {
          name: "Side-Lying Clamshell",
          sets: "2×15/side",
          rest: "30s",
          notes: "Add band wk2+. External rotation, don't roll hips back.",
        },
        {
          name: "Copenhagen Plank (short lever)",
          sets: "2×20s/side",
          rest: "45s",
          notes: "Top leg on bench, bottom knee on floor. Build to longer holds.",
        },
      ...
      exercises: [
        {
          ...
          sets: "4×5",
          rest: "2–3 min",
          notes: "Heavy. Progress load weekly. Full depth. This is the priority lift.",
        },
        {
          name: "Romanian Deadlift (Barbell)",
          sets: "3×6",
          rest: "90s",
          notes: "Moderate-heavy. Hamstring/posterior chain emphasis.",
        },
        {
          name: "Calf Raise (weighted)",
          sets: "3×8",
          rest: "60s",
          notes: "Heavy. Slow eccentric (3s down). Both straight & bent knee across weeks.",
        },
        {
          name: "Hanging Knee Raise",
          sets: "3×10",
          rest: "45s",
          notes: "Controlled. No swinging. Anti-extension core.",
        },
      ],
    },
    sessionB: {
      ...
      exercises: [
        {
          ...
          sets: "3×6/side",
          rest: "90s",
          notes: "Add dumbbells or barbell. Key single-leg strength builder.",
        },
        {
          name: "Single-Leg RDL",
          sets: "3×8/side",
          rest: "60s",
          notes: "Dumbbell or kettlebell. Balance + posterior chain.",
        },
        {
          name: "Copenhagen Plank (full lever)",
          sets: "3×20–30s/side",
          rest: "45s",
          notes: "Top leg on bench, bottom leg straight. Adductor strength.",
        },
        {
          name: "Inverted Row or DB Row",
          sets: "3×8",
          rest: "60s",
          notes: "Upper back strength. Postural support for running.",
        },
        {
          name: "Pallof Press w/ rotation",
          sets: "2×10/side",
          rest: "45s",
          notes: "Add a slow rotation component. Anti-rotation progression.",
        },
      ],
    },
  },
      ...
      exercises: [
        {
          ...
          sets: "3×4 (heavy)",
          rest: "2–3 min",
          notes: "Maintain peak load from Build phase. Fewer sets to manage fatigue.",
        },
        {
          name: "Step-Up (weighted, high box)",
          sets: "3×12/side",
          rest: "60s",
          notes: "Moderate weight, higher reps. Muscular endurance. Leg burn is the goal.",
        },
        {
          name: "Calf Raise (weighted)",
          sets: "3×12",
          rest: "45s",
          notes: "Moderate load. Eccentric emphasis (3s down).",
        },
        {
          name: "Plank Walkout",
          sets: "3×6",
          rest: "45s",
          notes: "From standing, walk out to plank, walk back. Full body control.",
        },
      ],
    },
    sessionB: {
      ...
      exercises: [
        {
          ...
          sets: "3×10/side",
          rest: "60s",
          notes: "Moderate dumbbells. Continuous movement. Simulates sustained leg load.",
        },
        {
          name: "Single-Leg RDL",
          sets: "3×8/side",
          rest: "60s",
          notes: "Maintain load from Build. Balance + hamstring endurance.",
        },
        ...
        {
          name: "Dead Bug w/ band",
          sets: "3×8/side",
          rest: "45s",
          notes: "Add resistance band pulling arms overhead. Core stability under load.",
        },
      ],
    },
  },
      ...
      <div key={key} style={{ marginBottom: "12px" }}>
        <button
          ...
          style={{
            width: "100%",
            padding: "12px 14px",
            background: isOpen ? "rgba(212,120,92,0.08)" : "rgba(255,255,255,0.02)",
    ...
    >
      ...
      {activeTab === "strength" && (
        <div style={{ padding: "16px 24px 20px" }}>
          ...
          >
            ...
            Do strength on non-running days or before easy runs (never before long runs or workouts). Separate running
            and lifting by ≥6 hours if on the same day.
          </div>
        </div>
      )}
      ...
      {activeTab === "guide" && (
        <div style={{ padding: "16px 24px 20px" }}>
          ...
          {[
            {
              title: "Strides",
              desc:
                "20-second accelerations to ~90% effort on flat ground. Smooth, relaxed form. Walk 60–90s between reps. Not sprints.",
            },
            {
              title: "Hill Sprints",
              desc:
                "8–10 second maximal effort up a steep hill (8–12% grade). Walk all the way down for full recovery (2–3 min). Builds raw power and fast-twitch fibers without anaerobic debt.",
            },
            {
              title: "Steady State",
              desc:
                "Continuous running between easy and tempo (~marathon effort). 'Comfortably hard' — short sentences OK. Builds lactate shuttling and fat oxidation.",
            },
            {
              title: "AeT Drift Test",
              desc:
                "Run 60 min at steady Z2. Compare avg HR in first 30 min vs second 30 min. <5% drift = strong base. >10% = room to grow.",
            },
          ].map((item, i) => (
            <div
              key={i}
          ...
          {[
            {
              text:
                "Lauersen et al. (2014, BJSM): Across 26,610 athletes, strength training reduced sports injuries to less than ⅓ (RR 0.315). Stretching showed no benefit.",
            },
            {
              text:
                "Lauersen et al. (2018, BJSM): Confirmed dose-dependent effect — a 10% increase in strength training volume reduced injury risk by >4 percentage points. Zero serious adverse events.",
            },
            {
              text:
                "Beattie et al. (2017, JSCR): 40 weeks of strength training significantly improved running economy and velocity at VO₂max without causing hypertrophy in competitive runners.",
            },
            {
              text:
                "Balsalobre-Fernández et al. (2016, JSCR): Meta-analysis found a large beneficial effect of strength training on running economy when performed 2–3×/week for 8–12 weeks.",
            },
            {
              text:
                "Meta-analysis (2024, Sports Med): High-load and combined strength methods produced the greatest running economy improvements, especially at faster speeds.",
            },
            {
              text:
                "Running-specific caveat: While general sports evidence for injury prevention is strong, running-specific RCTs show mixed results (Toresdahl 2019, multiple reviews). Supervised, progressive programs appear more effective than self-directed ones.",
            },
          ].map((item, i) => (
      ...
      >
        ...
        {[
          ...
          {
            num: "04",
            text: "Heavy compound lifts (squat, RDL, split squat) improve economy. Don't fear heavy loads.",
          },
          {
            num: "05",
            text:
              "Single-leg work builds stability. Calf raises protect Achilles. Copenhagen planks protect adductors.",
          },
          {
            num: "06",
            text:
              "Test AeT at weeks 4, 8, 12. After this block, add race-specific intensity while maintaining strength.",
          },
        ].map((p) => (
        ...
        >
          <strong>Scale to you:</strong>{" "}
          This plan starts at ~20 mi/week and peaks at ~36. Scale all distances proportionally. For strength, start with
          bodyweight if new to lifting — the movement patterns matter more than the load in weeks 1–4.
        </div>
      </div>
    </div>
  );
